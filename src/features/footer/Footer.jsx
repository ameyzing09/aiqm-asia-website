    ...
    <footer id="contact" className="bg-gray-900 dark:bg-black text-white py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
            ...
            <div className="flex flex-wrap gap-3">
              {accreditations.map((accreditation, index) => (
                <div key={index} className="px-4 py-2 bg-gray-800 rounded-lg text-sm">
                  {typeof accreditation === 'string' ? accreditation : accreditation.name || accreditation}
                </div>
              ))}
            </div>
          </div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400">
          <p>&copy; {companyInfo.copyrightYear} {companyInfo.name}. All rights reserved. | Privacy Policy | Terms of Service</p>
        </div>
      </div>
    </footer>
  )
