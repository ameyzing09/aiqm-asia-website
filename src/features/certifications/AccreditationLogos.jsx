        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            {sectionHeader?.description ||
              'Accredited by leading international bodies, ensuring your certification is recognized globally.'}
          </p>
        </div>
                ...
                return (
                  <Card key={accreditation.id} hover className="flex flex-col items-center p-6">
                    ...
                    <div className="w-full mb-6">
                      <div
                        className={`w-full h-32 bg-gradient-to-br ${colors.from} ${colors.to} rounded-lg flex items-center justify-center`}
                      >
