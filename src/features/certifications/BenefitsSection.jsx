    ...
    <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-primary-600 via-primary-700 to-accent-600">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-3xl lg:text-4xl font-bold text-white mb-4">{sectionHeader?.title}</h2>
          <p className="text-xl text-primary-100 max-w-3xl mx-auto">{sectionHeader?.description}</p>
        </div>
