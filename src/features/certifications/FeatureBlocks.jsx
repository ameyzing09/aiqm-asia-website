    ...
    >
      <Card hover className="overflow-hidden">
        <div className="flex flex-col lg:flex-row">
          {/* Icon Section */}
          <div
            className={`lg:w-1/3 bg-gradient-to-br ${colors.from} ${colors.to} p-8 lg:p-12 flex flex-col items-center justify-center text-white`}
          >
            <div className="mb-6">{FEATURE_ICONS[feature.iconType] || DEFAULT_ICON}</div>
            <h3 className="text-2xl lg:text-3xl font-bold text-center">{feature.title}</h3>
          </div>
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            {sectionHeader?.description ||
              'Key pillars that make our certifications the preferred choice for professionals worldwide'}
          </p>
        </div>
