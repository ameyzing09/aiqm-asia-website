...
const siteContentData = {
  ...
  testimonials: {
    testimonial_001: {
      quote: "AIQM's Black Belt certification transformed my career. The practical approach and expert mentorship were invaluable.",
      author: "Rajesh Kumar",
    ...
    testimonial_002: {
      quote: "Exceptional training program! The skills I gained have directly contributed to significant cost savings in our operations.",
      author: "Priya Sharma",
    ...
    testimonial_003: {
      quote: "World-class curriculum delivered by industry experts. This certification opened doors I never thought possible.",
      author: "Amit Patel",
  ...
  sectionHeaders: {
    featuredCourses: {
      ...
      description: "Industry-recognized certifications to accelerate your career in quality management"
    },
    testimonials: {
    ...
    services: {
      ...
      description: "Comprehensive consulting solutions tailored to your business needs, delivered by industry experts"
    },
    industries: {
    ...
    story: {
      title: "Our Story",
      description: "From humble beginnings to becoming India's premier quality excellence institute"
    },
    missionVision: {
    ...
    globalPresence: {
      ...
      description: "Serving organizations across 13 countries with world-class quality management solutions"
    },
    leadership: {
      title: "Leadership & Faculty",
      description: "Led by distinguished professionals from premier institutes, our team brings decades of combined experience in quality excellence"
    },
    accreditations: {
      title: "Our Accreditations",
      description: "AIQM India is accredited by leading international bodies, ensuring that your certification is recognized and valued across the globe."
    },
    benefits: {
      title: "Why Get Certified with AIQM India?",
      description: "Transform your career with certifications that deliver real, measurable results"
    }
  },
  ...
  about: {
    ...
    keyFacts: {
      ...
      trained: { title: "95,000+", description: "Professionals trained across industries", order: 3 },
      projects: { title: "11,000+", description: "Projects successfully delivered", order: 4 }
    },
    mission: {
      title: "Our Mission",
      statement: "To empower organizations and professionals across India and beyond with world-class quality management expertise, enabling them to achieve operational excellence and sustainable competitive advantage."
    },
    missionPoints: {
    ...
    vision: {
      title: "Our Vision",
      statement: "To be recognized as the leading catalyst for operational excellence in Asia, transforming one million professionals and one thousand organizations by 2030 through innovative quality management solutions."
    },
    visionPoints: {
  ...
  leadership: {
    director: {
      ...
      credentials: "Lean Six Sigma Master Black Belt | ISO Lead Auditor | Certified Corporate Director (IOD)",
      experience: "30+ years across Johnson & Johnson, Baker Gauges, and leadership of AIQM since 1995",
      recognition: "\"Outstanding People of the 20th Century Award\" — International Biographical Center, Cambridge, UK",
      photoUrl: ""
    },
    directorImpact: {
  ...
  faculty: {
    ...
    nagaraju: {
      ...
      expertise: "MBA (Marketing) • Certified in Big Data Analytics (Wiley USA) & Business Analytics (IIM Kozhikode)",
      photoUrl: "",
      order: 5
    }
  },
  ...
  certificationBenefits: {
    salary: {
      ...
      description: "Certified professionals see an average salary boost of 20-30% within the first year of certification.",
      iconType: "currency",
      order: 1
    },
    global: {
      title: "Globally Portable",
      description: "Your certification is recognized in 13+ countries, opening doors to international career opportunities.",
      iconType: "globe",
      order: 2
    },
    recognition: {
      title: "Industry Recognition",
      description: "Our certifications are recognized and respected across all major industries including IT, manufacturing, healthcare, and finance.",
      iconType: "education",
      order: 3
    }
  },
  ...
  industries: {
    manufacturing: { name: "Manufacturing", description: "Process optimization and quality improvement", projects: "5,000+", order: 1 },
    healthcare: { name: "Healthcare", description: "Patient care & operational efficiency", projects: "2,500+", order: 2 },
    it: { name: "IT & Technology", description: "Agile transformation & DevOps", projects: "3,200+", order: 3 },
    finance: { name: "Finance & Banking", description: "Risk management & compliance", projects: "1,800+", order: 4 },
    logistics: { name: "Logistics", description: "Supply chain optimization", projects: "2,000+", order: 5 },
    retail: { name: "Retail", description: "Customer experience & operations", projects: "1,500+", order: 6 }
  },
  ...
  return (
    <div className="p-6 bg-gray-800 rounded-xl border border-gray-700">
      ...
      <p className="text-gray-400 text-sm mb-6">
        Push the initial content blueprint to Firebase Realtime Database at path <code className="text-primary-400">siteContent/</code>
      </p>
