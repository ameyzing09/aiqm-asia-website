...
export function GlobalEditor() {
  ...
  const updateSocialLink = (id, field, value) =>
    setFormData(prev => ({
      ...prev,
      socialLinks: { ...prev.socialLinks, [id]: { ...prev.socialLinks[id], [field]: value } },
    }))
  ...
  const addSocialLink = () => {
    ...
    setFormData(prev => ({
      ...prev,
      socialLinks: { ...prev.socialLinks, [id]: { name: '', url: '', order: newOrder } },
    }))
  ...
  const deleteSocialLink = async id => {
    ...
    setFormData(prev => {
      const n = { ...prev.socialLinks }
      delete n[id]
      return { ...prev, socialLinks: n }
    })
    setInitialData(prev => {
      const n = { ...prev.socialLinks }
      delete n[id]
  ...
  const addAccreditation = () => {
    ...
    setFormData(prev => ({
      ...prev,
      accreditations: { ...prev.accreditations, [id]: { name: '', order: newOrder } },
    }))
  ...
  const deleteAccreditation = async id => {
    ...
    setFormData(prev => {
      const n = { ...prev.accreditations }
      delete n[id]
      return { ...prev, accreditations: n }
    })
    setInitialData(prev => {
      const n = { ...prev.accreditations }
      delete n[id]
    ...
    <div className="space-y-6 pb-24">
      <div>
        ...
        <p className="text-gray-400 mt-1">
          Manage company info, contact details, social links, and accreditations
        </p>
      </div>
      ...
      {activeTab === 'company' && (
        <FormCard
          ...
          description="Basic company details shown across the site"
        >
          <div className="grid grid-cols-12 gap-4">
            ...
            <ValidatedInput
              wrapperClassName="col-span-12 lg:col-span-6"
              label="Short Tagline (navigation)"
            ...
            <div className="col-span-6 lg:col-span-3">
              ...
              <input
                ...
                onChange={e =>
                  updateCompanyField('establishedYear', parseInt(e.target.value) || '')
                }
            ...
            <div className="col-span-6 lg:col-span-3">
              ...
              <input
                ...
                onChange={e => updateCompanyField('copyrightYear', parseInt(e.target.value) || '')}
                className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-lg text-white focus:outline-none focus:border-primary-500"
            ...
            <div className="col-span-12 pt-4 border-t border-white/10">
              <ValidatedInput
                ...
                onChange={v => setFormData(prev => ({ ...prev, enquiryLink: v }))}
                maxLength={CHAR_LIMITS.enquiryLink}
                placeholder="https://forms.gle/..."
                type="url"
              />
              <p className="text-xs text-gray-500 mt-1">
                Used for all "Enroll Now" and "Request Consultation" buttons
              </p>
            </div>
            ...
            <div className="col-span-12 pt-4 border-t border-white/10">
              <div className="flex items-center justify-between">
                <div>
                  <label className="text-sm font-medium text-white">Theme Switcher</label>
                  <p className="text-xs text-gray-400">
                    Allow users to change color theme in navigation
                  </p>
                </div>
                <label className="relative inline-flex items-center cursor-pointer">
                  <input
                    type="checkbox"
                    checked={formData.features?.enableThemeSwitcher || false}
                    onChange={e =>
                      setFormData(prev => ({
                        ...prev,
                        features: { ...prev.features, enableThemeSwitcher: e.target.checked },
                      }))
                    }
                    className="sr-only peer"
                  />
                  <div className="w-11 h-6 bg-gray-600 rounded-full peer peer-checked:bg-primary-600 peer-checked:after:translate-x-full after:content-[''] after:absolute after:top-0.5 after:left-[2px] after:bg-white after:rounded-full after:h-5 after:w-5 after:transition-all" />
                </label>
              </div>
            </div>
          </div>
      ...
      {activeTab === 'social' && (
        <MasterDetailLayout
          ...
          renderListItemMeta={link => (
            <p className="text-xs text-gray-500 truncate">{link.url || 'No URL'}</p>
          )}
            ...
            <div className="space-y-6">
              <div className="grid grid-cols-12 gap-4">
                <ValidatedInput
                  ...
                  onChange={v => updateSocialLink(selectedSocial.id, 'name', v)}
                ...
                <ValidatedInput
                  ...
                  onChange={v => updateSocialLink(selectedSocial.id, 'url', v)}
                ...
                <div className="col-span-6 lg:col-span-4">
                  ...
                  <input
                    type="number"
                    value={selectedSocial.order || 0}
                    onChange={e =>
                      updateSocialLink(selectedSocial.id, 'order', parseInt(e.target.value) || 0)
                    }
                    className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-lg text-white focus:outline-none focus:border-primary-500"
                    min={0}
                  />
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-primary-400/70 mt-1">
                      ...
                      whatsapp. The icon is auto-detected from the name.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="pt-6 border-t border-white/10 flex justify-end">
                <button
                  onClick={() => deleteSocialLink(selectedSocial.id)}
      ...
      {activeTab === 'accreditations' && (
        <MasterDetailLayout
          ...
          renderListItemMeta={acc => (
            <p className="text-xs text-gray-500">Order: {acc.order || 0}</p>
          )}
        ...
        >
          {selectedAccreditation && (
            <div className="space-y-6">
              ...
              <div className="bg-accent-600/10 border border-accent-500/20 rounded-xl p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-accent-400/70 mt-1">
                      These badges are displayed in the website footer as trust indicators. Use
                      common accreditation names like ISO 9001, IRCA, etc.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="pt-6 border-t border-white/10 flex justify-end">
                <button
                  onClick={() => deleteAccreditation(selectedAccreditation.id)}
                  className="flex items-center gap-2 px-4 py-2.5 bg-red-500/10 hover:bg-red-500/20 text-red-400 border border-red-500/20 rounded-lg"
                >
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path
