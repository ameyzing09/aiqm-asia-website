    ...
    <div className={wrapperClassName}>
      <div className={`space-y-2 ${className}`}>
        ...
        >
          ...
          {value && !uploading && (
            <div
              className={`relative ${aspectRatio} rounded-xl overflow-hidden border border-white/10`}
            >
          ...
          {uploading && (
            <div
              className={`${aspectRatio} bg-white/5 border border-white/10 rounded-xl flex flex-col items-center justify-center p-6`}
            >
