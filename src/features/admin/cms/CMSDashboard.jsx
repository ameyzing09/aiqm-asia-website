  ...
  return (
    <div className="space-y-8">
      ...
      <div className="backdrop-blur-xl bg-white/5 border border-white/10 rounded-2xl p-6 lg:p-8">
        <h1 className="text-2xl lg:text-3xl font-bold text-white mb-2">Welcome to AIQM CMS</h1>
        <p className="text-gray-400 max-w-2xl">
          Manage your website content with ease. Select a section below to start editing. All
          changes are saved to Firebase and reflect instantly on the live site.
        </p>
      </div>
      ...
      <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {quickActions.map(action => (
            ...
            >
              <div
                className={`w-14 h-14 bg-gradient-to-br ${action.color} rounded-xl flex items-center justify-center text-white mb-4 group-hover:scale-110 transition-transform`}
              >
                {action.icon}
              </div>
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-400">
              Each editor shows character limits to ensure content fits properly. Changes are
              validated before saving, and the live site updates instantly via React Query cache
              invalidation.
            </p>
          </div>
        </div>
