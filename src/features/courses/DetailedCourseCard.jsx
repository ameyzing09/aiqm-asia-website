      ...
      <div className="flex flex-col flex-grow p-6 space-y-4">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          {course.mode.map(mode => (
            <span
              key={mode}
              className="px-3 py-1.5 bg-accent-50 dark:bg-accent-900/20 text-accent-700 dark:text-accent-400 text-xs font-medium rounded-lg"
            >
              {mode}
            </span>
          ))}
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-2">
            {course.accreditation.map(acc => (
              <div
                key={acc}
                className="flex items-center gap-1.5 px-3 py-1.5 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg"
              >
                <svg
