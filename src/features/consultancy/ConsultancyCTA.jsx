...
export function ConsultancyCTA() {
  ...
  const statsDisplay = [
    ...
    {
      value: satisfactionStat
        ? `${satisfactionStat.value}${satisfactionStat.suffix || '%'}`
        : '98%',
          ...
          <div className="text-center">
            ...
            <div className="flex flex-wrap justify-center gap-6 mb-12">
              {[1, 2, 3, 4].map(i => (
                <div
                  key={i}
                  className="flex-1 min-w-[calc(50%-0.75rem)] md:min-w-[calc(25%-1.125rem)] bg-white/10 rounded-lg p-6 animate-pulse"
                >
  ...
  return (
    <section
      ...
      className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-primary-600 via-primary-700 to-accent-600"
    >
      <div className="max-w-5xl mx-auto">
        {/* Main CTA Card */}
        <div className="text-center">
          ...
          <p className="text-xl text-primary-100 mb-8 max-w-2xl mx-auto">
            {sectionHeader?.description ||
              'Transform your business with data-driven strategies and expert consulting. Join 500+ companies that have achieved sustainable growth with us.'}
          </p>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-8 border border-white/20 max-w-3xl mx-auto">
            <svg
              className="w-10 h-10 text-white/40 mb-4 mx-auto"
              fill="currentColor"
              viewBox="0 0 20 20"
            >
            ...
            <p className="text-lg text-white italic mb-4">
              ...
              {featuredTestimonial?.quote ||
                "AIQM India's consultancy services transformed our operations. We achieved a 40% efficiency gain and ₹8 Cr in annual savings within the first year."}
              &quot;
            </p>
            <div className="text-primary-100">
              {featuredTestimonial ? (
                ...
                <>
                  <span className="font-semibold">VP Operations</span> • Fortune 500 Logistics
                  Company
                </>
              )}
            </div>
