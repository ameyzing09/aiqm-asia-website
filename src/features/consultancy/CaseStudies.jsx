    ...
    imagePlaceholder: (
      <div className="aspect-video bg-gradient-to-br from-blue-50 via-blue-100 to-blue-200 dark:from-blue-900 dark:via-blue-800 dark:to-gray-900 rounded-lg flex items-center justify-center overflow-hidden">
        <div className="text-center p-6">
          <svg
            className="w-16 h-16 mx-auto text-blue-600 dark:text-blue-400 mb-3"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
  ...
  'logistics-case': {
    ...
    imagePlaceholder: (
      <div className="aspect-video bg-gradient-to-br from-green-50 via-green-100 to-green-200 dark:from-green-900 dark:via-green-800 dark:to-gray-900 rounded-lg flex items-center justify-center overflow-hidden">
        <div className="text-center p-6">
          <svg
            className="w-16 h-16 mx-auto text-green-600 dark:text-green-400 mb-3"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
  ...
  'healthcare-case': {
    ...
    imagePlaceholder: (
      <div className="aspect-video bg-gradient-to-br from-purple-50 via-purple-100 to-purple-200 dark:from-purple-900 dark:via-purple-800 dark:to-gray-900 rounded-lg flex items-center justify-center overflow-hidden">
        <div className="text-center p-6">
          <svg
            className="w-16 h-16 mx-auto text-purple-600 dark:text-purple-400 mb-3"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
...
const defaultStyle = {
  ...
  imagePlaceholder: (
    <div className="aspect-video bg-gradient-to-br from-gray-50 via-gray-100 to-gray-200 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 rounded-lg flex items-center justify-center overflow-hidden">
      <div className="text-center p-6">
        <svg
          className="w-16 h-16 mx-auto text-gray-600 dark:text-gray-400 mb-3"
          fill="none"
          stroke="currentColor"
          viewBox="0 0 24 24"
        >
        ...
        <p className="text-sm font-medium text-gray-700 dark:text-gray-300">Case Study Image</p>
      </div>
    </div>
  ),
}
                      ...
                      <div className="pt-2">
                        ...
                        <div className="flex flex-wrap gap-4">
                          {[1, 2, 3, 4].map(j => (
                            <div
                              key={j}
                              className="flex-1 min-w-[calc(50%-0.5rem)] min-h-[88px] bg-gray-200 dark:bg-gray-700 rounded-lg p-4"
                            >
                  ...
                  <Card key={study.id} hover className="overflow-hidden">
                    <div className="flex flex-col lg:flex-row gap-8 p-6 lg:p-8">
                      ...
                      <div className="flex-1 order-2 lg:order-2">
                        ...
                        <div className="mb-6">
                          <div
                            className={`inline-block px-3 py-1 bg-gradient-to-r ${style.color} text-white text-sm font-semibold rounded-full mb-3`}
                          >
                            {study.industry}
                          </div>
                        ...
                        <div>
                          ...
                          <div className="flex flex-wrap gap-4">
                            {study.outcomes.map((outcome, outcomeIndex) => (
                              <div
                                key={outcomeIndex}
                                className="flex-1 min-w-[calc(50%-0.5rem)] bg-gray-50 dark:bg-gray-800 rounded-lg p-4 border border-gray-200 dark:border-gray-700"
                              >
