    ...
    imagePlaceholder: (
      <div className="aspect-video bg-gradient-to-br from-blue-100 to-blue-200 dark:from-blue-900 dark:to-blue-800 rounded-t-xl flex items-center justify-center">
        <div className="text-center p-4">
          <svg
            className="w-12 h-12 mx-auto text-blue-600 dark:text-blue-400"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
  ...
  'project-mentoring': {
    ...
    imagePlaceholder: (
      <div className="aspect-video bg-gradient-to-br from-orange-100 to-orange-200 dark:from-orange-900 dark:to-orange-800 rounded-t-xl flex items-center justify-center">
        <div className="text-center p-4">
          <svg
            className="w-12 h-12 mx-auto text-orange-600 dark:text-orange-400"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
...
const defaultStyle = {
  ...
  imagePlaceholder: (
    <div className="aspect-video bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-900 dark:to-gray-800 rounded-t-xl flex items-center justify-center">
      <div className="text-center p-4">
        <svg
          className="w-12 h-12 mx-auto text-gray-600 dark:text-gray-400"
          fill="none"
          stroke="currentColor"
          viewBox="0 0 24 24"
        >
        ...
        <div className="flex flex-wrap gap-8">
          {isLoading
            ? [1, 2, 3, 4].map(i => (
                <Card
                  key={i}
                  className="flex flex-col h-full w-full md:w-[calc(50%-1rem)] animate-pulse"
                >
            ...
            : services?.map(service => {
                ...
                return (
                  <Card
                    key={service.id}
                    hover
                    className="flex flex-col h-full w-full md:w-[calc(50%-1rem)]"
                  >
                    {/* Service Image */}
                    <div className="mb-6">
                      {service.image ? (
                    ...
                    <div className="px-6 pb-6">
                      ...
                      <div className="flex items-center mb-4">
                        <div
                          className={`w-16 h-16 bg-gradient-to-br ${style.color} rounded-lg flex items-center justify-center text-white mr-4 flex-shrink-0`}
                        >
                          {style.icon}
                        </div>
