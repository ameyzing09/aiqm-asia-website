      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-wrap gap-8">
          {services.map((service) => (
            <Card key={service.title} hover className="flex flex-col h-full w-full md:w-[calc(50%-1rem)]">
              {/* Image Placeholder */}
              <div className="mb-6">
              ...
              <div className="px-6 pb-6">
                ...
                <div className={`w-16 h-16 bg-gradient-to-br ${service.color} rounded-lg flex items-center justify-center text-white mr-4 flex-shrink-0`}>
                  {service.icon}
                </div>
