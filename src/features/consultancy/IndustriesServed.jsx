        ...
        <div className="flex flex-wrap justify-center gap-6">
          {isLoading
            ? [1, 2, 3, 4, 5, 6].map(i => (
                <Card
                  key={i}
                  className="text-center p-6 w-[calc(50%-0.75rem)] md:w-[calc(33.333%-1rem)] lg:w-[calc(16.666%-1.25rem)] animate-pulse"
                >
            ...
            : industries?.map(industry => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="mb-4">
                      <div
                        className={`aspect-square bg-gradient-to-br ${iconData.bgClass} rounded-lg flex items-center justify-center`}
                      >
